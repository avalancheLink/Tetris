...
class GameViewController: UIViewController {
    ...
    func tick()
    {
        if block1 <= 10 || labelArray[block1-10].backgroundColor != UIColor.blackColor() {
            NStimer.invalidate()
            spawnAnotherBlock()
        } else if block2 <= 10 || labelArray[block2-10].backgroundColor != UIColor.blackColor() {
            NStimer.invalidate()
            spawnAnotherBlock()
        } else if block3 <= 10 || labelArray[block3-10].backgroundColor != UIColor.blackColor() {
            NStimer.invalidate()
            spawnAnotherBlock()
        } else if block4 <= 10 || labelArray[block4-10].backgroundColor != UIColor.blackColor() {
            NStimer.invalidate()
            spawnAnotherBlock()
        }
